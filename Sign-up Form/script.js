// this code is taken from SitePoint's constraint validation api example, my aim is not to copy but to try out and help myself remember such usage for form validation
...
contactForm.addCustom(confirmPassword, (f) => f.value === password.value);
